...
function ConvertToStringifiableObject(object){
    if(object instanceof Array) return internal_ConvertToStringifiableObject(object.map(ConvertToStringifiableObject([],object)))
    if(object instanceof Object && !(object instanceof Array)) return internal_ConvertToStringifiableObject($.extend({}, object))
    else return internal_ConvertToStringifiableObject(object)
}
